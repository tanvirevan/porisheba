  ...
  return (
    <div>
      <div className="Hero_img relative">
        <div className="absolute inset-0 w-full h-full bg-gray-900 bg-opacity-30"></div>
        <Image
          className="w-[100%] mt-20 h-[440px] bg-cover"
          src={heroImage}
          alt="img"
        />
      </div>
      <div className="text-white z-90 absolute top-[165px] left-[150px] w-1/2 mt-16 ">
        ...
        <div className="flex text-black">
          <select
            className="mt-4 py-3 px-4 rounded border-none outline-none"
            name=""
            id=""
          >
          ...
          <select
            className="mt-4 ml-5 py-3 px-4 rounded text-blue-600 border-none outline-none"
            name=""
            id=""
          >
